...
| <a name="input_opertor_search_elastic_instance_minimum"></a> [opertor\_search\_elastic\_instance\_minimum](#input\_opertor\_search\_elastic\_instance\_minimum) | The number of minimum instances for this function app. Only affects apps on the Premium plan. | `number` | `1` | no |
