...
| <a name="input_notification_sender_email"></a> [notification\_sender\_email](#input\_notification\_sender\_email) | n/a | `string` | n/a | yes |
...
| <a name="input_xml_content"></a> [xml\_content](#input\_xml\_content) | n/a | `string` | n/a | yes |
