...
module "ade_aa_mock" {
  ...
  allowed_subnets = contains(["u"], var.env_short) ? [data.azurerm_subnet.subnet_apim_v2.id, module.subnet_spid_login.id] : [azurerm_subnet.subnet_apim.id, module.subnet_spid_login.id, module.subnet_api.id]
  allowed_ips     = []
